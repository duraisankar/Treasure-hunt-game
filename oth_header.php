...
<nav class="top-bar">
  <ul>
    <li class="name"><h1><a href="#" id="notifications" style="">Notifications</a></h1></li>
  ...
  <ul>
    ...
    <li class="name">
	<a class="th"><img src="images/techvibesimage100x60.jpg" /></a>
	</li>
	<li class="search">_____</li>
	<li class="name"><h1><a href="#" id="onlineTreasureHunt" style="font-weight: 900;">Online Treasure Hunt</a></h1></li>
  </ul>
    <!-- Building the Nav -->
<section>
  <ul class="right">
...
<div id="subNav">
	<div class="row">
		<dl class="sub-nav right">
		  ...
		  <dd>/</dd>
		  <dd id="leaderboard"><a href="leaderboard.php?page=1">Leaderboard</a></dd>
		  <dd>/</dd>

...
<html lang="en">
  ...
  <head>
    ...
    src: url('http://drestein.in/goodtimesrg-regular-webfont.woff') format('woff2'),
         url('http://drestein.in/goodtimesrg-regular-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal;
  ...
  h1{ font-family: 'good_times_rgregular';
    font-size:3vw;
color: #d8d5d5;}
...
.text--center {
  ...
  <body class="align">
    ...
    <div class="grid">
     ...
     <center><h1>Nest 17 login</h1></center>
...
<h3>Please check your username and password </h3>
      ...
      <p class="text--center">Cant able to login? mail to<a href="#"> tressurehunt@sec-nest.org</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
